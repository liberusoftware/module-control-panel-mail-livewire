...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-control-panel-mail-livewire?sort=semver)](https://github.com/liberusoftware/module-control-panel-mail-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-control-panel-mail-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-control-panel-mail-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-control-panel-mail-livewire
```
...
<a href="https://github.com/liberusoftware/module-control-panel-mail-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-control-panel-mail-livewire" alt="Contributors to liberusoftware/module-control-panel-mail-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-control-panel-mail-livewire/graphs/contributors).
